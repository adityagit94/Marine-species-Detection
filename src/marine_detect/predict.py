"""
Marine Detection Inference Module.

This module provides functions for running inference on marine species detection models.
Supports both image and video processing with YOLOv8 models.
"""
